var data = [
    {
        ...
        "first_name":"Adam",
        "last_name":"milne",
        "preferred_name":"Adam milne",
        "job_title":"SharePoint Practice Head",
        "department":"IT Department",
        "email":"adam.m@gmail.com",
        "office":"Seattle",
        "phone_number":"9246289627",
        "skype_id":"9472874852818",
        "profile_pic":"./Assets/person1.jpg"
    },
    {
        "id":"2",
        "first_name":"Katy",
        "last_name":"Mathews",
        "preferred_name":"Katy Mathews",
        "job_title":"Operations Manager",
        "department":"IT Department",
        "email":"kumar.k@gmail.com",
        "office":"Seattle",
        "phone_number":"7264128312",
        "skype_id":"8235135895281",
        "profile_pic":"./Assets/person2.jpg"
    },
    {
        "id":"3",
        "first_name":"Surya",
        "last_name":"Williams",
        "preferred_name":"Surya Williams",
        "job_title":"Product Manager",
        "department":"IT Department",
        "email":"suryawilliams@gmail.com",
        "office":"Seattle",
        "phone_number":"7527637272",
        "skype_id":"7254161763716",
        "profile_pic":"./Assets/person3.jpg"
    },
    {
        "id":"4",
        "first_name":"Mary",
        "last_name":"Smith",
        "preferred_name":"Mary Smith",
        "job_title":"Product Manager",
        "department":"IT Department",
        "email":"marysmith@gmail.com",
        "office":"Seattle",
        "phone_number":"9543456789",
        "skype_id":"7254161763716",
        "profile_pic":"./Assets/person4.jpg"
},
{
    "id":"5",
        "first_name":"Elis",
        "last_name":"Perry",
        "preferred_name":"Elis Perry",
        "job_title":"Product Manager",
        "department":"IT Department",
        "email":"elisperry@gmail.com",
        "office":"Seattle",
        "phone_number":"9543456789",
        "skype_id":"7254161763716",
        "profile_pic":"./Assets/person5.jpg"
},
{
    "id": "6",
    "first_name": "Ervin",
    ...
    "profile_pic":"./Assets/person10.jpg"
},
{
    "id": "7",
    "first_name": "Dennis",
    ...
    "profile_pic":"./Assets/person9.jpg"
},
{
    "id": "8",
    "first_name": "Chelsey",
    ...
    "skype_id":"",
    "profile_pic":"./Assets/person6.jpg"
}


    
]
Map=[["Preferred Name","preferred_name"],["First Name","first_name"],["Last Name","last_name"],["Job Title","job_title"],["Department","department"],["Email","email"],["Office","office"],["Phone Number","phone_number"],["Skype Id","skype_id"]] //maps with corresponding values
employeeCounter=1
let searchBarValue="";
...
var loadFile = function(event) {                         //creates url for images
	image.src = URL.createObjectURL(event.target.files[0]);
};

function EmailValidation(inputtxt){           //checks if email is in correct format or not
    var reg=/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/
    return reg.test(inputtxt)
}

function AllEmpty(){               //checks weather any filter is selected or not
...
function allLetter(inputtxt)       //checks if name is greater than 3 digits or not 
                                   //also checks if name contains only alphabets
{
...
function allNumbers(inputtxt){      //checks weather phone number contains all numbers or not
                                    // phone number should start with 6,7,8,9 in india
    if(inputtxt==""){
        return true 
    }
...
function titleCase(str) {                     // makes the first letter of name to Capital
...
function OpenError(inputtxt){
    document.getElementById("error").appendChild(document.createTextNode(inputtxt)) //shows error message
...
function Validator(){    //validates all the input format and prevents exceptions
...
function insert(){                      //for adding new data into original data
    ...
    if(newData.phone_number==""){
        newData.phone_number="NA"             //if phoneno and skype id does not present 
                                             // stores its values as NA
    }
    if(newData.skype_id==""){
        newData.skype_id="NA"
    }
...
function ClearForm(){                   //for clearing values in the form
...
function AddEmployee(inputList){        //adds new card for employes with details
    ...
    call.src=""
    call.className="fa fa-phone-square"                 //creating font icons using font awsome
    call.id="contactImg"
...
function showHiddenJobs(){   //functionality for show more jobs
...
//functionality for getting data by different attributes
